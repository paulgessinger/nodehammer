...
[[nodiscard]] WedgeCutStats applyWedgeCut(detail::SemanticScene &scene,
                                          const WedgeCutParams &params);
...
class WedgeCutJob {
  public:
    ...
    void start(detail::SemanticScene &scene, const WedgeCutParams &params);
