...
TEST_CASE("SyntheticSceneBuilder: buildSingleBox -- geometry correct", "[import][synthetic]") {
    auto scene = nodehammer::ir::SyntheticSceneBuilder::buildSingleBox();
...
TEST_CASE("SyntheticSceneBuilder: buildWithDiagnostics -- UnknownShape degradation flag set",
          "[import][synthetic]") {
    auto result = nodehammer::ir::SyntheticSceneBuilder::buildWithDiagnostics();
    ...
    REQUIRE(root.degradation.has(nodehammer::ir::DegradationBit::UnknownShape));
}
...
TEST_CASE("SyntheticSceneBuilder: buildBooleanSubtraction -- boolean shape present",
          "[import][synthetic]") {
    auto scene = nodehammer::ir::SyntheticSceneBuilder::buildBooleanSubtraction();
