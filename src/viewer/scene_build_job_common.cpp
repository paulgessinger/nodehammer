...
void logPreBuild(const std::filesystem::path &config_path,
    ...
    std::println(std::cerr,
                 ...
                 "(exists={} size={})",
                 config_path.string(), config_exists ? 1 : 0, static_cast<size_t>(config_size),
                 input_path.string(), input_exists ? 1 : 0, static_cast<size_t>(input_size));
